...
const App = {
    ...
    methods: {
        ...
        findProductInCartItems(productID) {
            for (let product of this.cartItems) {
                if (productID === product.id_product) {
                    return product;
                }
            } // ЭТОТ ЦИКЛ РАБОТАЕТ НЕКОРРЕКТНО
        },
        addProduct(product) {
            console.log(product);
            console.log(product.id_product);
            let isExistInCartItems = this.findProductInCartItems(product.id_product)
            if (isExistInCartItems !== undefined) {
                isExistInCartItems.quantity++;
            }   else {
        ...
        countCartItemsCost() {
            ...
            // ТУТ ДОЛЖНО БЫЛО БЫТЬ ВЫРАЖЕНИЕ, ПОДСЧИТЫВАЮЩЕЕ СУММАРНУЮ СТОИМОСТЬ ВСЕХ ТОВАРОВ
        }
    },
    mounted() {
